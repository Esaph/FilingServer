...
public class ContactDTO implements Serializable
{
    ...
    public static final String SERIAZABLE_ID = "esaph.filing.KundenManagement.ContactDTO";
    ...
    public void setOtherAddressFormat(String country, String postCode, String city, String street)
    {
        this.formatedAdress = (TextUtils.isEmpty(country) ? "" : country) //Building address from raw data.
                + " "
                + (TextUtils.isEmpty(city) ? TextUtils.isEmpty(postCode) ? "" : postCode : city)
                + " "
